<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionConductor.aspx.cs" Inherits="Vista.gestionConductor" %>
...
<body>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-group">
                <label for="txtName">Nombre Conductor</label>
                <asp:TextBox ID="txtName" runat="server" class="form-control"></asp:TextBox>
            </div>
          
            <div class="form-group">
                <label for="txtName">Tipo de Licencia</label>
                <asp:TextBox ID="txtLicencia" runat="server" class="form-control"></asp:TextBox>
            </div>

            <div class="form-group">
                <label for="txtName">Id_Vehiculo</label>
                <asp:TextBox ID="txtIdvehiculo" runat="server" class="form-control"></asp:TextBox>
            </div>

            <div class="form-group">
                <label for="txtName">id_tipo_conductor</label>
                <asp:TextBox ID="txtTipconductor" runat="server" class="form-control"></asp:TextBox>
            </div>
                    ...
                    <th>
                        <asp:GridView runat="server" ID="GridView" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundField DataField="tipo_licencia" HeaderText="Licencia"/>
