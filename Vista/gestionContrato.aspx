<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionContrato.aspx.cs" Inherits="Vista.gestionContrato" %>
                    ...
                    <th>
                        <asp:GridView runat="server" ID="GridView" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundField DataField="id_conductor" HeaderText="idConductor"/>
                                <asp:BoundField DataField="id_vehiculo" HeaderText="idVehiculo"/>
                            </Columns>
                        </asp:GridView>
                    </th>
                </tr>
