<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionTipoConductor.aspx.cs" Inherits="Vista.gestionTipoConductor" %>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-row">
                ...
                <div class="px-2">
                    <asp:Button ID="btnModify" runat="server" Text="Modificar" class="btn btn-warning" OnClick="btnUpdate_Click"/>  
                </div>
                    ...
                    <th>
                        <asp:GridView runat="server" ID="GridView" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Tipo_Conductor" HeaderText="Nombre"/>
                            </Columns>
                        </asp:GridView>
                    </th>
                </tr>
